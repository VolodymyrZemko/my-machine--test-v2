...
const trackMyMachineLoginClick = () => {
  try {
    window.gtmDataObject?.push({
      ...
      local_event_action:'logged out - click to login',
      local_event_label:'log in here',    
...
const trackNoMachinesView = () => {
  try {
    window.gtmDataObject?.push({
      event: 'local_event', //as is, do not change!!
      local_event_category: 'machine assistance', 
      local_event_action:'logged in - my machines - no registered machines',
...
const trackNoMachinesRegisterClick = () => {
  try {
    window.gtmDataObject?.push({
      event: 'local_event', //as is, do not change!!
      local_event_category: 'machine assistance', 
      local_event_action:'logged in - my machines - no registered machines - click to my account',
      local_event_label:'here',    
      event_raised_by:'local_market_gr'
    });
  } catch (e) {}
...
const trackMyAccountClick = () => {
  try {
    window.gtmDataObject?.push({
      event: 'local_event', //as is, do not change!!
      local_event_category: 'machine assistance', 
      local_event_action:'logged in - my machines - click to my account',
      local_event_label:'edit in my account',    
      event_raised_by:'local_market_gr'
    });
  } catch (e) {}
...
const trackTroubleshootingClick = () => {
  try {
    window.gtmDataObject?.push({
      event: 'local_event', //as is, do not change!!
      local_event_category: 'machine assistance', 
      local_event_action:'logged in - my machines - click to troubleshooting',
      local_event_label:'troubleshooting',    
      event_raised_by:'local_market_gr'
    });
  } catch (e) {}
